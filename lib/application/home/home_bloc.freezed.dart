...
/// @nodoc
mixin _$HomeState {
  String get stateIid => throw _privateConstructorUsedError;
  List<HotAndNewData> get pastYearMovieList =>
      throw _privateConstructorUsedError;
  List<HotAndNewData> get trendingMovieList =>
      throw _privateConstructorUsedError;
  List<HotAndNewData> get tensedDramasMoveList =>
      throw _privateConstructorUsedError;
  List<HotAndNewData> get sountindianMovieList =>
      throw _privateConstructorUsedError;
...
abstract class $HomeStateCopyWith<$Res> {
  ...
  $Res call(
      ...
      List<HotAndNewData> tensedDramasMoveList,
      List<HotAndNewData> sountindianMovieList,
...
class _$HomeStateCopyWithImpl<$Res, $Val extends HomeState>
  ...
  @override
  $Res call({
    Object? stateIid = null,
    Object? pastYearMovieList = null,
    Object? trendingMovieList = null,
    Object? tensedDramasMoveList = null,
    Object? sountindianMovieList = null,
    Object? trendingTvList = null,
    Object? isLoading = null,
    Object? hasError = null,
  }) {
    return _then(_value.copyWith(
      stateIid: null == stateIid
          ? _value.stateIid
          : stateIid // ignore: cast_nullable_to_non_nullable
              as String,
      ...
      trendingMovieList: null == trendingMovieList
          ...
          : trendingMovieList // ignore: cast_nullable_to_non_nullable
              as List<HotAndNewData>,
      tensedDramasMoveList: null == tensedDramasMoveList
          ? _value.tensedDramasMoveList
          : tensedDramasMoveList // ignore: cast_nullable_to_non_nullable
              as List<HotAndNewData>,
      sountindianMovieList: null == sountindianMovieList
          ? _value.sountindianMovieList
          : sountindianMovieList // ignore: cast_nullable_to_non_nullable
              as List<HotAndNewData>,
    ...
    return _then(_$_Initial(
      ...
      trendingMovieList: null == trendingMovieList
          ...
          : trendingMovieList // ignore: cast_nullable_to_non_nullable
              as List<HotAndNewData>,
      tensedDramasMoveList: null == tensedDramasMoveList
          ? _value._tensedDramasMoveList
          : tensedDramasMoveList // ignore: cast_nullable_to_non_nullable
              as List<HotAndNewData>,
      sountindianMovieList: null == sountindianMovieList
          ? _value._sountindianMovieList
          : sountindianMovieList // ignore: cast_nullable_to_non_nullable
              as List<HotAndNewData>,
      trendingTvList: null == trendingTvList
...
class _$_Initial implements _Initial {
  const _$_Initial(
      {required this.stateIid,
      required final List<HotAndNewData> pastYearMovieList,
      required final List<HotAndNewData> trendingMovieList,
      required final List<HotAndNewData> tensedDramasMoveList,
      required final List<HotAndNewData> sountindianMovieList,
      ...
      : _pastYearMovieList = pastYearMovieList,
        ...
        _tensedDramasMoveList = tensedDramasMoveList,
        _sountindianMovieList = sountindianMovieList,
        _trendingTvList = trendingTvList;

  @override
  final String stateIid;
  ...
  final List<HotAndNewData> _tensedDramasMoveList;
  @override
  List<HotAndNewData> get tensedDramasMoveList {
    if (_tensedDramasMoveList is EqualUnmodifiableListView)
      return _tensedDramasMoveList;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_tensedDramasMoveList);
  }

  final List<HotAndNewData> _sountindianMovieList;
  @override
  List<HotAndNewData> get sountindianMovieList {
    if (_sountindianMovieList is EqualUnmodifiableListView)
      return _sountindianMovieList;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_sountindianMovieList);
  }
  ...
  @override
  String toString() {
    return 'HomeState(stateIid: $stateIid, pastYearMovieList: $pastYearMovieList, trendingMovieList: $trendingMovieList, tensedDramasMoveList: $tensedDramasMoveList, sountindianMovieList: $sountindianMovieList, trendingTvList: $trendingTvList, isLoading: $isLoading, hasError: $hasError)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$_Initial &&
            (identical(other.stateIid, stateIid) ||
                other.stateIid == stateIid) &&
            const DeepCollectionEquality()
                .equals(other._pastYearMovieList, _pastYearMovieList) &&
            const DeepCollectionEquality()
                .equals(other._trendingMovieList, _trendingMovieList) &&
            const DeepCollectionEquality()
                .equals(other._tensedDramasMoveList, _tensedDramasMoveList) &&
            const DeepCollectionEquality()
                .equals(other._sountindianMovieList, _sountindianMovieList) &&
            const DeepCollectionEquality()
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(_tensedDramasMoveList),
      const DeepCollectionEquality().hash(_sountindianMovieList),
...
abstract class _Initial implements HomeState {
  const factory _Initial(
      {required final String stateIid,
      required final List<HotAndNewData> pastYearMovieList,
      required final List<HotAndNewData> trendingMovieList,
      required final List<HotAndNewData> tensedDramasMoveList,
      required final List<HotAndNewData> sountindianMovieList,
